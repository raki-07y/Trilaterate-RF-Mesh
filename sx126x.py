...
# "20,868,Hello World"
    ...
    def receive(self):
        if self.ser.inWaiting() > 0:
            ...
            print("receive message from node address with frequence\033[1;32m %d,%d\033[0m"%((r_buff[0]<<8)+r_buff[1],r_buff[2]+self.start_freq),end='\r\n',flush = True)
            data_slice = r_buff[3:-1]
            message = data_slice.decode()
            print("message is \033[1;37m %s \033[0m" % message, end='\r\n')
